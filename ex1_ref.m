...
for controller_id = 1:num_of_controllers
    ...
    subplot(2, 1, 2); hold on; stairs(1:logger.num_of_element, logger.u(1, :),  colors{controller_id},'LineWidth', 0.7*(num_of_controllers - controller_id)+1); 
end
